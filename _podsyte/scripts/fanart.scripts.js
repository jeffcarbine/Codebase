...
import { twoStepDeleteTemplate } from "/admin/templates/twoStepDelete.template.js";
...
const generateFanartList = () => {
  ...
  xhr({ path: "/admin/fanart/retrieve", success });
...
const approveFanart = (checkbox) => {
  ...
  xhr({ path: "/admin/fanart/approve", body: { id, approved }, success });
};
